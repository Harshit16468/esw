 ...
 */
#define BLYNK_TEMPLATE_ID "TMPL3Ix5-8vwe"
#define BLYNK_TEMPLATE_NAME "Esw project"
...
char auth[] = "1qDWKmO9hUptgyq_9jyGeT6e_CUyx5Oe"; // Blynk authentication token
...
void loop() {
  ...
  if (client) {
    ...
    Serial.print(temperature);
    Blynk.virtualWrite(V2,(int) temperature); // Sending sensor data to V1 in Blynk app
    
    Serial.println(" °C");
    Serial.print("Humidity: ");
    Serial.print(humidity);
    Blynk.virtualWrite(V3,(int) humidity); // Sending sensor data to V1 in Blynk app

    Serial.println(" %");
    Serial.print("MQ-2 Sensor Data:");
    Serial.print("Sensor Value: ");
    Serial.println(mq2reading);
   Blynk.virtualWrite(V0,(int) mq2reading); // Sending sensor data to V1 in Blynk app
   if (mq2reading == 0)
{
   Blynk.logEvent("smoke_detected");
    ...
    Blynk.virtualWrite(V1,(int) mq135reading); // Sending sensor data to V1 in Blynk app
if (mq135reading > 1500)
{
   Blynk.logEvent("co2_levels_high");
}
    Serial.println("BMP:");
    Serial.print("Pressure: ");
    Serial.println(pressure);
    Blynk.virtualWrite(V4,(int) pressure); // Sending sensor data to V1 in Blynk app
