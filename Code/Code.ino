...
void mqttPublish(long pubChannelID, char* pubWriteAPIKey, float dataValue1, float dataValue2, float dataValue3) {
  String topicString = "channels/" + String(pubChannelID) + "/publish";
  String dataString = "field1=" + String(dataValue1, 2);
  dataString+= "field2=";
  dataString+= String(dataValue2, 2);
  dataString+= "field3=";
  dataString+= String(dataValue3, 3);
...
void loop() {
  ...
  Serial.println();
  mqttPublish(ChannelID, APIKey, temperatureDHT, humidityDHT, sensorValueMQ2);
